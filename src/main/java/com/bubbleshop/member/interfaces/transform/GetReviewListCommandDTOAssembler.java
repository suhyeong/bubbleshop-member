...
public abstract class GetReviewListCommandDTOAssembler {
    ...
    protected void afterMappingToCommand(@MappingTarget GetReviewListCommand.GetReviewListCommandBuilder builder,
        ...
        builder.createdStartDate(DateTimeUtil.convertStringToDateTime(DATE_FORMAT_YYYY_MM_DD_DASH, createdStartDate, LocalTime.MIN));
        builder.createdEndDate(DateTimeUtil.convertStringToDateTime(DATE_FORMAT_YYYY_MM_DD_DASH, createdEndDate, LocalTime.MAX));
    }
