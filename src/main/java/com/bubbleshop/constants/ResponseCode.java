...
public enum ResponseCode {
    ...
    SERVICE_UNAVAILABLE("00","02", "서비스를 이용할 수 없습니다.", HttpStatus.SERVICE_UNAVAILABLE),
    ...
    MEMBER_PASSWORD_ERROR("02", "02", "비밀번호가 일치하지 않습니다. 비밀번호를 확인해주세요.", HttpStatus.BAD_REQUEST),
